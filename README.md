...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/resdk-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15187&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/resdk-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `resdk` can be installed with:

```
conda install resdk
```

It is possible to list all of the versions of `resdk` available on your platform with:
